...
// If statement 1
if(hemlock < 0.75 || (NerveGas > 0.66 && AmanitaMushrooms < 0.66)) {
  calcium_chloride -= 0.01;
}

// If statement 2  
if(sarin > 0.27 && Snake_Venom > 0.44 && insecticide > 0.35 || cyanide > 0.49 && Snake_Venom > 0.44 && insecticide > 0.35) {
  calcium_chloride += 0.05; 
}

// If statement 3
if(AmanitaMushrooms > 0.29 || Snake_Venom < 0.26 || 
  (hemlock > 0.42 && sarin > 0.55)) {
    CalciumGluconate -= 0.04;
}

// If statement 4
if(insecticide < 0.31 || arsenic > 0.3 || 
   NerveGas < 0.71 || cyanide < 0.69) {
    CalciumGluconate += 0.05;
}

// If statement 5 
if(NerveGas > 0.38 || sarin < 0.53 || 
   arsenic < 0.61 || cyanide > 0.33) {
    antibodies -= 0.05;
}

// If statement 6
if(insecticide < 0.29 && hemlock > 0.58 && 
   AmanitaMushrooms > 0.52) {
    antibodies += 0.01;
}

// If statement 7
if(Snake_Venom < 0.41 && 
   insecticide < 0.67|| hemlock > 0.27 && 
   insecticide < 0.67) {
    aspirin -= 0.01;
}  

// If statement 8 
if(cyanide < 0.63 && NerveGas > 0.53|| AmanitaMushrooms > 0.34 &&
   NerveGas > 0.53) {
    aspirin += 0.02;
}

// If statement 9
if(NerveGas > 0.41 || AmanitaMushrooms < 0.57 || Snake_Venom > 0.35) {
    plasma -= 0.01;
}

// If statement 10
if(arsenic > 0.66 && insecticide > 0.61 && sarin < 0.5 || hemlock > 0.61 && insecticide > 0.61 && sarin < 0.5) {
    plasma += 0.03;
}
