...
Officer: 1845677
CaseNum: 402-3-52183769-1845677
...
function draw()
{
    ...
    else if (det.locationY == 330 && det.locationX == 73)
	{
		det.speedX = 1;
		det.speedY = 0;
	}

     else if (det.locationY == 330 && det.locationX == 270)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
    
     else if (det.locationY == 125 && det.locationX == 270)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
    
     else if (det.locationY == 125 && det.locationX == 390)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
    
    else if (det.locationY == 570 && det.locationX == 390)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
    
    else if (det.locationY == 570 && det.locationX == 520)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
    
     else if (det.locationY == 260 && det.locationX == 520)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
    
     else if (det.locationY == 260 && det.locationX == 710)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
    ...
    else if (det.locationY == 640 && det.locationX == 710)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
    
     else if (det.locationY == 640 && det.locationX == 900)
	{
		det.speedX = 0;
		det.speedY = -1;
	}
