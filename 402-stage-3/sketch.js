...
Officer: 1845677
CaseNum: 402-2-64990727-1845677
...
function draw()
{
  ...
  else if (det.locationX == 261 && det.locationY > 630) {
  det.speedX = 0;
  det.speedY = -1; }
    else if (det.locationX == 261 && det.locationY == 450) {
  det.speedX = 1;
  det.speedY = 0;
    
}
    else if(det.locationX == 510 && det.locationY == 450)
        {
            det.speedX=0;
            det.speedY=-1;
        }
    
    else if(det.locationX == 510 && det.locationY == 200)
        {
            det.speedX=1;
            det.speedY=0;
        }
    else if(det.locationX == 760 && det.locationY == 200)
        {
            det.speedX=0;
            det.speedY=-1;
        }
      else if (det.locationX == 760 && det.locationY == 70) {
            det.speedX=1;
            det.speedY=0;
        }
