...
Officer: 1845677
CaseNum: 403-0-51559263-1845677
...
- To sound the alarm, draw a DarkViolet rectangle covering the remainder of the map from Romero Avenue to the east.
...
function draw()
{
  ...
  // Check if Shiffman crossed Romero Ave
  if(mouseX > 1100) 
  {

    // Sound alarm by drawing rectangle
    fill(148,0,211);
    rect(1100, 0, width - 1100, height);
  }
